insert into orsdb.disaster_calamities(sy_from,school_id,
djan,dfeb,dmar,dapr,dmay,djun,djul,daug,dsep,doct,dnov,ddec,
ejan,efeb,emar,eapr,emay,ejun,ejul,eaug,esep,eoct,enov,edec,
fijan,fifeb,fimar,fiapr,fimay,fijun,fijul,fiaug,fisep,fioct,finov,fidec,
fjan,ffeb,fmar,fapr,fmay,fjun,fjul,faug,fsep,foct,fnov,fdec,
ljan,lfeb,lmar,lapr,lmay,ljun,ljul,laug,lsep,loct,lnov,ldec,
ssjan,ssfeb,ssmar,ssapr,ssmay,ssjun,ssjul,ssaug,sssep,ssoct,ssnov,ssdec,
tcjan,tcfeb,tcmar,tcapr,tcmay,tcjun,tcjul,tcaug,tcsep,tcoct,tcnov,tcdec,
tjan,tfeb,tmar,tapr,tmay,tjun,tjul,taug,tsep,toct,tnov,tdec,
vejan,vefeb,vemar,veapr,vemay,vejun,vejul,veaug,vesep,veoct,venov,vedec,
acjan,acfeb,acmar,acapr,acmay,acjun,acjul,acaug,acsep,acoct,acnov,acdec,
cshjan,cshfeb,cshmar,cshapr,cshmay,cshjun,cshjul,cshaug,cshsep,cshoct,cshnov,cshdec,
cspjan,cspfeb,cspmar,cspapr,cspmay,cspjun,cspjul,cspaug,cspsep,cspoct,cspnov,cspdec,
csjan,csfeb,csmar,csapr,csmay,csjun,csjul,csaug,cssep,csoct,csnov,csdec,
ctjan,ctfeb,ctmar,ctapr,ctmay,ctjun,ctjul,ctaug,ctsep,ctoct,ctnov,ctdec,
firjan,firfeb,firmar,firapr,firmay,firjun,firjul,firaug,firsep,firoct,firnov,firdec,
htjan,htfeb,htmar,htapr,htmay,htjun,htjul,htaug,htsep,htoct,htnov,htdec,
osjan,osfeb,osmar,osapr,osmay,osjun,osjul,osaug,ossep,osoct,osnov,osdec,
secjan,secfeb,secmar,secapr,secmay,secjun,secjul,secaug,secsep,secoct,secnov,secdec,
scjan,scfeb,scmar,scapr,scmay,scjun,scjul,scaug,scsep,scoct,scnov,scdec,
ojan,ofeb,omar,oapr,omay,ojun,ojul,oaug,osep,ooct,onov,odec,others,
ecjan,ecfeb,ecmar,ecapr,ecmay,ecjun,ecjul,ecaug,ecsep,ecoct,ecnov,ecdec,
vulnerabilities01,vulnerabilities02,vulnerabilities03)
