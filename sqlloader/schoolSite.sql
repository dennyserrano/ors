insert into orsdb.school_site(school_year,school_id,site_ownership,proof_of_ownership,ownership_issue,topography,yr_donation,
yr_purchase,yr_usufruct,yr_expropriation,yr_exchange,yr_proclamation,yr_others,proof_title,proof_tax,proof_sale,proof_donation,
proof_proclamation,proof_usufruct,proof_moa,proof_others,legal_adverse,legal_encroachment,legal_others,topography_flat,
topography_rolling,topography_hilly,topography_others,land_area)
