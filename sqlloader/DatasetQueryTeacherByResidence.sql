insert into orsdb.teacher_by_residence(school_year,school_id,teacher_within_brgy,teacher_outside_brgy,teacher_within_citymun,
teacher_outside_citymun)

select sph.sy_from, sph.school_id, ifnull(osd.teacher_within_brgy,0), ifnull(osd.teacher_outside_brgy,0), 
ifnull(osd.teacher_within_citymun,0), ifnull(osd.teacher_outside_citymun,0)
