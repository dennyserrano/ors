...
BS.number_of_rooms as rm_number,
...
SUM(IF(RAU.id=14,1,0)) as als_rm,
...
INNER JOIN ebeisdb.report_history RH on RH.school_id = SPH.school_id and RH.sy_from = SPH.sy_from 
