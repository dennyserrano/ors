...
LEFT JOIN ref_report_history rrh on (reports.id=rrh.report_id and rrh.sy_from = CAST(2013 AS CHAR))
...
WHERE sph.SY_FROM = 2013 AND sph.general_classification_id = 7 AND sph.co_gen_class in (433,434) 
