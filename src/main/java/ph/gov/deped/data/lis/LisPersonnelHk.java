 ...
 */
@Entity
@Table(name = "personnel_hk", catalog = "lis2db", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "LisPersonnelHk.findAll", query = "SELECT p FROM LisPersonnelHk p")})
public class LisPersonnelHk implements Serializable {
    ...
    public LisPersonnelHk() {
    }

    public LisPersonnelHk(Integer id) {
        this.id = id;
    }

    public LisPersonnelHk(Integer id, String firstName, String middleName, String lastName, Date createdAt) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LisPersonnelHk)) {
            return false;
        }
        LisPersonnelHk other = (LisPersonnelHk) object;
    ...
    public String toString() {
        return "ph.gov.deped.data.lis.LisPersonnelHk[ id=" + id + " ]";
    }
