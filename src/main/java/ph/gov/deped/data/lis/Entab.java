...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Entab.findAll", query = "SELECT e FROM Entab e")})
public class Entab implements Serializable {
    ...
    public Entab(Integer id) {
        this.id = id;
    }

    public Entab(Integer id, short sy, long lrn, short enrolType, int schoolClassId, Date firstLoginDt, short repeater, short grade1Ecd, short balikAral, short muslim, short aliveEnrolled, short giftedTalented, Date updatedAt, int schoolTermId, int schoolId) {
        this.id = id;
        this.sy = sy;
        this.lrn = lrn;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Entab)) {
            return false;
        }
        Entab other = (Entab) object;
    ...
    public String toString() {
        return "ph.gov.deped.data.lis.Entab[ id=" + id + " ]";
    }
