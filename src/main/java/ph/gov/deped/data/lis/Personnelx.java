 ...
 */
@Entity
@Table(name = "personnelx", catalog = "lis2db", schema = "", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"first_name", "middle_name", "last_name", "gender", "birthdate"}),
    @UniqueConstraint(columnNames = {"office_id", "first_name", "middle_name", "last_name", "gender", "birthdate"}),
    @UniqueConstraint(columnNames = {"school_id", "first_name", "middle_name", "last_name", "gender", "birthdate"})})
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Personnelx.findAll", query = "SELECT p FROM Personnelx p")})
public class Personnelx implements Serializable {
    ...
    public Personnelx(Integer id) {
        this.id = id;
    }

    public Personnelx(Integer id, String firstName, String middleName, String lastName, Date createdAt) {
        this.id = id;
    ...
    public Short getEmploymentTypeId() {
        return employmentTypeId;
    }

    public void setEmploymentTypeId(Short employmentTypeId) {
    ...
    public Short getFundingTypeId() {
        return fundingTypeId;
    }

    public void setFundingTypeId(Short fundingTypeId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Personnelx)) {
            return false;
        }
        Personnelx other = (Personnelx) object;
    ...
    public String toString() {
        return "ph.gov.deped.data.lis.Personnelx[ id=" + id + " ]";
    }
