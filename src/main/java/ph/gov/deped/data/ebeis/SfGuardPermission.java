 ...
 */
@Entity
@Table(name = "sf_guard_permission", catalog = "sisdb", schema = "", uniqueConstraints = {
...
public class SfGuardPermission implements Serializable {
    ...
    @ManyToMany(mappedBy = "sfGuardPermissionList")
    ...
    public SfGuardPermission(Integer id) {
        this.id = id;
    }

    public SfGuardPermission(Integer id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SfGuardPermission)) {
            return false;
        }
        SfGuardPermission other = (SfGuardPermission) object;
    ...
    public String toString() {
        return "ph.gov.deped.data.ebeis.LisSfGuardPermission[ id=" + id + " ]";
    }
