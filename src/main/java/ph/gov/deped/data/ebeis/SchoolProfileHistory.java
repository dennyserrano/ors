 ...
 */
@Entity
@Table(name = "school_profile_history", catalog = "sisdb", schema = "", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"sy_from", "school_id"})})
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "SchoolProfileHistory.findAll", query = "SELECT s FROM SchoolProfileHistory s")})
public class SchoolProfileHistory implements Serializable, JpaEntity<Integer> {
    ...
    @Column(name = "school_profile_historycol", length = 45)
    private String schoolProfileHistorycol;
    @OneToMany(mappedBy = "schoolProfileHistoryId")
    private List<ProgramsOfferedHistory> programsOfferedHistoryList;
    ...
    public SchoolProfileHistory() {
    }

    public SchoolProfileHistory(Integer id) {
        this.id = id;
    }

    public SchoolProfileHistory(Integer id, short syFrom, int schoolId, String schoolName, String streetAddress, Date dateEstablished, short generalClassificationId, short curricularClassId, short siteOwnershipId, short proofOfOwnershipId, short ownershipIssueId, short topographyId, short coGenClass, Date createdAt, Date updatedAt) {
        this.id = id;
        this.syFrom = syFrom;
    ...
    public String getSchoolProfileHistorycol() {
        return schoolProfileHistorycol;
    }

    public void setSchoolProfileHistorycol(String schoolProfileHistorycol) {
        this.schoolProfileHistorycol = schoolProfileHistorycol;
    }

    @XmlTransient
    public List<ProgramsOfferedHistory> getProgramsOfferedHistoryList() {
        return programsOfferedHistoryList;
    }

    public void setProgramsOfferedHistoryList(List<ProgramsOfferedHistory> programsOfferedHistoryList) {
        this.programsOfferedHistoryList = programsOfferedHistoryList;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SchoolProfileHistory)) {
            return false;
        }
        SchoolProfileHistory other = (SchoolProfileHistory) object;
    ...
    public String toString() {
        return "ph.gov.deped.data.ebeis.LisSchoolProfileHistory[ id=" + id + " ]";
    }
