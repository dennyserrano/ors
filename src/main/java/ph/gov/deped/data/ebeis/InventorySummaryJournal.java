 ...
 */
@Entity
@Table(name = "inventory_summary_journal", catalog = "sisdb", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "InventorySummaryJournal.findAll", query = "SELECT i FROM InventorySummaryJournal i")})
public class InventorySummaryJournal implements Serializable {
    ...
    public InventorySummaryJournal() {
    }

    public InventorySummaryJournal(Integer id) {
        this.id = id;
    }

    public InventorySummaryJournal(Integer id, int originalId, Date originalCreatedAt, Date originalUpdatedAt, Date createdAt) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InventorySummaryJournal)) {
            return false;
        }
        InventorySummaryJournal other = (InventorySummaryJournal) object;
    ...
    public String toString() {
        return "ph.gov.deped.data.ebeis.InventorySummaryJournal[ id=" + id + " ]";
    }
