 ...
 */
@Entity
@Table(name = "enrollment_pupil_summary_journal", catalog = "sisdb", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EnrollmentPupilSummaryJournal.findAll", query = "SELECT e FROM EnrollmentPupilSummaryJournal e")})
public class EnrollmentPupilSummaryJournal implements Serializable {
    ...
    public EnrollmentPupilSummaryJournal() {
    }

    public EnrollmentPupilSummaryJournal(Integer id) {
        this.id = id;
    }

    public EnrollmentPupilSummaryJournal(Integer id, int originalId, Date originalCreatedAt, Date originalUpdatedAt, Date createdAt) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EnrollmentPupilSummaryJournal)) {
            return false;
        }
        EnrollmentPupilSummaryJournal other = (EnrollmentPupilSummaryJournal) object;
    ...
    public String toString() {
        return "ph.gov.deped.data.ebeis.EnrollmentPupilSummaryJournal[ id=" + id + " ]";
    }
