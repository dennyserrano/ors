 ...
 */
@Entity
@Table(name = "enrolment", catalog = "lis2db", schema = "", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"school_term_id", "school_id", "learner_registry_id", "duplicate_arbiter"})})
@XmlRootElement
@NamedQueries({
...
public class Enrolment implements Serializable {
    ...
    @Column(name = "to_acknowledge_date")
    @Temporal(TemporalType.TIMESTAMP)
    private Date toAcknowledgeDate;
    @Column(name = "to_acknowledge")
    private Short toAcknowledge;
    @Column(name = "to_comment", length = 250)
    private String toComment;
    @Column(name = "to_acknowledge_by")
    private Integer toAcknowledgeBy;
    ...
    public Enrolment(Integer id, short sy, short enrolType, Date firstLoginDt, short repeater, short grade1Ecd, short balikAral, short muslim, short aliveEnrolled, short giftedTalented, int schoolTermId, int schoolId, Date updatedAt) {
        this.id = id;
        this.sy = sy;
    ...
    public Short getTransOut() {
        return transOut;
    }

    public void setTransOut(Short transOut) {
    ...
    public Date getToAcknowledgeDate() {
        return toAcknowledgeDate;
    }

    public void setToAcknowledgeDate(Date toAcknowledgeDate) {
        this.toAcknowledgeDate = toAcknowledgeDate;
    }

    public Short getToAcknowledge() {
        return toAcknowledge;
    }

    public void setToAcknowledge(Short toAcknowledge) {
    ...
    public Integer getToAcknowledgeBy() {
        return toAcknowledgeBy;
    }

    public void setToAcknowledgeBy(Integer toAcknowledgeBy) {
        this.toAcknowledgeBy = toAcknowledgeBy;
    }
    ...
    public Integer getResolvedFlag() {
        return resolvedFlag;
    }

    public void setResolvedFlag(Integer resolvedFlag) {
    ...
    public String toString() {
        return "ph.gov.deped.data.lis.Enrolment[ id=" + id + " ]";
    }
