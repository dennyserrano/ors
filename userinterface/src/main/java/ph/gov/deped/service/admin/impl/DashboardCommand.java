...
public @Command class DashboardCommand implements ICommand<DashboardContext> {
    ...
    private @Autowired(required = false) DataSource ebeisDataSource;
    
    private @Autowired(required = false) DataSource lisDataSource;
    
    private @Autowired(required = false) DataSource dataSource;
