 ...
 */
@Entity
@Table(name = "personnel_position_bak", catalog = "sisdb", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PersonnelPositionBak.findAll", query = "SELECT p FROM PersonnelPositionBak p")})
public class PersonnelPositionBak implements Serializable {
    ...
    public PersonnelPositionBak() {
    }

    public PersonnelPositionBak(Integer id) {
        this.id = id;
    }

    public PersonnelPositionBak(Integer id, int reportHistoryId, Date createdAt, Date updatedAt) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PersonnelPositionBak)) {
            return false;
        }
        PersonnelPositionBak other = (PersonnelPositionBak) object;
    ...
    public String toString() {
        return "ph.gov.deped.data.ebeis.PersonnelPositionBak[ id=" + id + " ]";
    }
