 ...
 */
@Entity
@Table(name = "enrollment_sp_summary_journal", catalog = "sisdb", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EnrollmentSpSummaryJournal.findAll", query = "SELECT e FROM EnrollmentSpSummaryJournal e")})
public class EnrollmentSpSummaryJournal implements Serializable {
    ...
    public EnrollmentSpSummaryJournal() {
    }

    public EnrollmentSpSummaryJournal(Integer id) {
        this.id = id;
    }

    public EnrollmentSpSummaryJournal(Integer id, int originalId, Date originalCreatedAt, Date originalUpdatedAt, Date createdAt) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EnrollmentSpSummaryJournal)) {
            return false;
        }
        EnrollmentSpSummaryJournal other = (EnrollmentSpSummaryJournal) object;
    ...
    public String toString() {
        return "ph.gov.deped.data.ebeis.EnrollmentSpSummaryJournal[ id=" + id + " ]";
    }
